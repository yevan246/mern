...
export default function TodoItem({ todo }) {
  ...
  const handleTextUpdate = () => {
    setEditMode(false);
    handleUpdate(todo._id, { text: editInput });
  };
      ...
      <div className="flex items-center justify-center">
        {editMode ? (
          <>
            ...
            />
            {/* e.target - сам элемент, с которым было произведено событие  */}
            <button onClick={handleTextUpdate}>save</button>
          </>
        ) : (
          <span
        ...
        <input
          ...
          type="checkbox"
          checked={todo.done}
          onChange={(e) => handleUpdate(todo._id, { done: e.target.checked })}
        />
        <svg
